...
;; Se utilizo IA para:
;; -En primera instancia, para aclarar y recordar conceptos sobre la FNC, observar cadenas validas y casos singulares
;; como por ejemplo donde solo se tenga UNA clausula o un literal, y pedirle casos de prueba para probar la correctitud
;; -Se uso tambien para extender conocimientos sobre el tema de abstracciones y TAD visto clases y comprender con certeza
